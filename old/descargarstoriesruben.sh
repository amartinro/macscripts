...
CUENTA_INSTAGRAM="ruben.atienza"
LOGIN_INSTAGRAM="boss_the_shiba"

# Define el directorio de destino
DIRNAME="/Users/amartin/Library/CloudStorage/GoogleDrive-a.martinro@gmail.com/Mi unidad/Clientes video/RubenAtienza/RAStories/"
